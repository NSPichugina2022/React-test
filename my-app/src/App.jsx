...
function App() {
    ...
    React.useEffect(() => {
        ...
        async function axiosData(){
            ...
            const tyrsData = await axios.get('https://638c8265eafd555746a7d670.mockapi.io/tyrs')
            const cartData = await axios.get('https://638c8265eafd555746a7d670.mockapi.io/cart')
            const favoritesData = await axios.get('https://638c8265eafd555746a7d670.mockapi.io/favorites')
    ...
    const deleteItems=(id)=>{
        console.log(id);
        axios.delete(`https://638c8265eafd555746a7d670.mockapi.io/cart/${id}`)
